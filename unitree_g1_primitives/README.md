...
## Quick Start
In order to control the real robot, please refer to [these controllers](https://github.com/unitreerobotics/xr_teleoperate/tree/main/teleop/robot_control), since they were tested and compatible. Also they can be used also in Mujoco.
